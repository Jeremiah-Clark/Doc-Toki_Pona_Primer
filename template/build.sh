...
OUTPUT="../toki_pona_primer-latest.pdf"

# List your Markdown content files below, in reading order.
# Use relative paths from this script's directory.
INPUT_FILES=(
  ../content/toki_pona_primer-0_Intro.md
  ../content/toki_pona_primer-1_Grammar.md
  ../content/toki_pona_primer-2_FulLWordList.md
  ../content/toki_pona_primer-3_NameRules.md
