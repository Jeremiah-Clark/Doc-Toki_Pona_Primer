...
> [!TIP]
> 
> `mi sona` = *"I know"* vs. `mi kama sona` = *"I'm learning"* (moving toward knowledge)
...
> [!TIP]
>
> Use `lon` before a relational word to identify a spatial relationship.
>
> `soweli li lon insa tomo` — *"The animal is in the house."*
